...
return (
    ...
    <ul className="space-y-3">
        ...
        <li
            key={meal.idMeal}
            className="flex items-center bg-slate-700 rounded-md p-2 hover:bg-blue-300 transition-all duration-200 ease-out hover:scale-105 hover:translate-x-5 hover:shadow-lg"
        >
